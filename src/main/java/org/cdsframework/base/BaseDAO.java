...
public abstract class BaseDAO<T extends BaseDTO> implements BaseDAOInterface<T> {
    ...
    protected List<String> dmlConstraints = new ArrayList<>();
    protected List<String> queryMapPredicates = new ArrayList<>();
    private final Map<String, BaseRowMapper<? extends BaseDTO>> tableMapperMap = new HashMap<>();
    private Map<String, String> sortFieldOrderByMap = new HashMap<>();
