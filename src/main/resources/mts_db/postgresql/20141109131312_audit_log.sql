...
create table audit_log (
            ...
            last_mod_id varchar(32),
            last_mod_datetime timestamp,
            create_datetime timestamp not null);

alter table audit_log add constraint fk_audit_log_to_audit foreign key (transaction_id) references audit_transaction (transaction_id);
