 ...
 */
@Stateless
public class UserSecurityMapBO extends BaseBO<UserSecurityMapDTO> {

    @EJB
    private UserSecurityMGRLocal userSecurityMGRLocal;

    @Override
    protected void postDelete(UserSecurityMapDTO baseDTO, Class queryClass, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
    ...
    @Override
    protected void postUpdate(UserSecurityMapDTO baseDTO, Class queryClass, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
            throws ConstraintViolationException, NotFoundException, MtsException, ValidationException, AuthenticationException,
            AuthorizationException {
        userSecurityMGRLocal.refreshUserSecuritySchemePermissionMap(baseDTO);
    }
    ...
    @Override
    protected void postAdd(UserSecurityMapDTO baseDTO, Class queryClass, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
            throws ConstraintViolationException, NotFoundException, MtsException, ValidationException, AuthenticationException,
            AuthorizationException {
        userSecurityMGRLocal.refreshUserSecuritySchemePermissionMap(baseDTO);
    }
